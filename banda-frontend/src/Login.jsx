            ...
            <div className="w-full lg:w-1/2 flex flex-col justify-center p-6 sm:p-8 lg:p-12 relative z-10 overflow-y-auto max-h-screen">
                ...
                >
                    ...
                    <motion.div variants={itemVariants} className="flex flex-col mb-6">
                        ...
                        <h1 className="text-2xl sm:text-3xl font-black text-slate-900 tracking-tight text-center lg:text-left">Sign In</h1>
                    </motion.div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <motion.div variants={itemVariants} className="space-y-1.5">
                            <div className="flex justify-between items-center">
                                ...
                                <Link to="/forgot-password" className="text-xs font-bold text-blue-700 hover:text-blue-900 underline-offset-4 hover:underline transition-all">Forgot password?</Link>
                            </div>
                            <div className="relative group">
                    ...
                    <motion.div variants={itemVariants} className="mt-6 pt-5 border-t border-slate-100 text-center">
                        <span className="text-slate-500 text-xs sm:text-sm font-medium">First time here? </span>
                        <Link to="/register" className="text-blue-700 font-bold hover:text-blue-900 underline-offset-4 hover:underline transition-all text-xs sm:text-sm">
                            Create New Account
                        </Link>
                    </motion.div>
                </motion.div>
