                    ...
                    return (
                      ...
                      >
                        <div className="w-full md:w-48 h-48 md:h-auto bg-slate-100 flex-shrink-0 relative overflow-hidden">
                          <img src={`/storage/${aduan.gambar_bukti}`} alt={aduan.jenis_kerosakan} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
                        </div>
